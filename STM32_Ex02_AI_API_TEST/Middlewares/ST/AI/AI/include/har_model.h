...
#ifndef __AI_HAR_MODEL_H__
#define __AI_HAR_MODEL_H__
#pragma once

#include "ai_platform.h"

#define AI_HAR_MODEL_MODEL_NAME          "har_model"

#define AI_HAR_MODEL_IN_NUM       (1)
#define AI_HAR_MODEL_IN_1  \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 90, 3, 1, 1, NULL)
#define AI_HAR_MODEL_IN_1_SIZE \
  (90 * 3 * 1)

#define AI_HAR_MODEL_OUT_NUM      (1)
#define AI_HAR_MODEL_OUT_1  \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 6, 1, NULL)
#define AI_HAR_MODEL_OUT_1_SIZE \
  (1 * 1 * 6)
 ...
 * @ref ai_har_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_har_model_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_HAR_MODEL_*
 * defines into file @ref har_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_har_model_forward(
  ai_handle network, const ai_buffer* input);


AI_API_DECLARE_END

#endif /*__AI_HAR_MODEL_H__*/
