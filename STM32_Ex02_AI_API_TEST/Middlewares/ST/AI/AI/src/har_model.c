...
#define AI_NET_OBJ_INSTANCE g_har_model
 
#undef AI_HAR_MODEL_MODEL_SIGNATURE
#define AI_HAR_MODEL_MODEL_SIGNATURE     "dc582ba86ee8a11fd06b698b258a4310"
...
#define AI_TOOLS_DATE_TIME   "Tue Apr  9 15:21:28 2019"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_HAR_MODEL_N_BATCHES
#define AI_HAR_MODEL_N_BATCHES         (1)
...
AI_DECLARE_STATIC
ai_bool har_model_configure_activations(
...
AI_DECLARE_STATIC
ai_bool har_model_configure_weights(
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_HAR_MODEL_MODEL_NAME,
      ...
      .inputs            = AI_BUFFER_OBJ_INIT(
                              ...
                              1,
                              1, NULL),
      .n_outputs         = AI_HAR_MODEL_OUT_NUM,
  ...
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= har_model_configure_weights(net_ctx, &params->params);
  ok &= har_model_configure_activations(net_ctx, &params->activations);
